...
Transfermarkt’s value picture is sharply top-heavy. That matters analytically, because it tells you where the talent ceiling sits inside the squad: on transition forwards and central midfield ball-carriers rather than on the back line. citeturn17search11turn9view0
...
*This recent-match table is compiled from the national-team results chronology on Wikipedia plus Soccerway/FIFA-linked match reports attached there.* citeturn32view0turn31view1turn30search5

Across that best-verified 14-match run, Haiti went 5-4-5 with 22 goals scored and 17 conceded. The trendline is instructive rather than smooth: a poor June 2025 reset after the heavy Curaçao defeat, a disappointing Gold Cup, a strong autumn qualification surge, then a March wobble followed by the emphatic 4-0 win over New Zealand. citeturn32view0turn31view1

The flow below visualises the most meaningful steps in that recent arc. citeturn32view0turn31view1

```mermaid
flowchart LR
    A["7 Jun 2025<br/>Aruba 0-5 Haiti"] --> B["10 Jun 2025<br/>Haiti 1-5 Curaçao"]
    B --> C["22 Jun 2025<br/>USA 2-1 Haiti"]
    C --> D["9 Sep 2025<br/>Costa Rica 3-3 Haiti"]
    D --> E["9 Oct 2025<br/>Nicaragua 0-3 Haiti"]
    E --> F["13 Oct 2025<br/>Honduras 3-0 Haiti"]
    F --> G["13 Nov 2025<br/>Haiti 1-0 Costa Rica"]
    G --> H["18 Nov 2025<br/>Haiti 2-0 Nicaragua"]
    H --> I["31 Mar 2026<br/>Haiti 1-1 Iceland"]
    I --> J["2 Jun 2026<br/>Haiti 4-0 New Zealand"]
```

Because official all-competition player passing and defensive aggregates are not consistently published in accessible formats for Haiti, the statistical summary below uses three layers: World Cup qualifying player output from Soccerway, official Gold Cup team statistics from Concacaf, and an official detailed Gold Cup match report sample against Saudi Arabia. Where data were not published in an accessible source, the entry is marked “n/a”. citeturn29view0turn34search1turn36view0
...
*Gold Cup team statistics are from Concacaf’s official team page; the Saudi Arabia row is from the official Concacaf post-match report; the final-round qualification line is derived directly from the verified match results above.* citeturn34search1turn36view0turn33search2turn32view0
